...
flowchart TD
    ...
    subgraph delphi["Дельфи-консенсус"]
        ...
        MED --> R2["Раунд 2<br/>пересмотр оценок"]
        R2 --> JUDGE["Judge<br/>таймлайн событий"]
    end
...
```mermaid
flowchart TD
    A["470M исторических ставок<br/>1.7M участников Polymarket"] --> B["Brier Score каждого участника<br/>на разрешённых рынках"]
    B --> C{"Классификация"}
