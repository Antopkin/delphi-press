...
DEFAULT_ASSIGNMENTS: dict[str, ModelAssignment] = {
    "news_scout_search": ModelAssignment(
        ...
        fallback_models=["yandexgpt-lite"],
        temperature=0.3,
    ),
...
# === Model diversity для Delphi (спека §3.3) ===
...
assert len(set(DELPHI_PERSONA_MODELS.values())) == len(DELPHI_PERSONA_MODELS), (
    "Delphi persona models must be unique"
)
