...
**Обоснование выбора модели**: Claude Sonnet демонстрирует сильное следование инструкциям и сбалансированную оценку вероятностей. Хорошо работает с nuanced рассуждениями, не склонен к крайним оценкам -- соответствует консервативному характеру персоны.
...
**Обоснование выбора модели**: GPT-4o обладает широким охватом знаний о международных отношениях и демонстрирует способность строить многоуровневые причинно-следственные цепочки. Модельное разнообразие: семейство OpenAI vs. Anthropic для первой персоны.
...
**Модель**: `google/gemini-2.5-pro` (через OpenRouter)
**Обоснование выбора модели**: Gemini Pro демонстрирует сильные аналитические способности в структурированных задачах. Модельное разнообразие: семейство Google vs. Anthropic/OpenAI. Хорошо работает с числовыми данными и экономическими показателями.
...
**Модель**: `yandexgpt` (YandexGPT API напрямую)
**Обоснование выбора модели**: YandexGPT обучен на большом объёме русскоязычного медиа-контента и лучше понимает стилистику российских СМИ. Для анализа русскоязычных изданий -- идеальный выбор. Модельное разнообразие: российский провайдер vs. западные модели.
...
**Модель**: `meta-llama/llama-3.3-70b-instruct` (через OpenRouter)
**Обоснование выбора модели**: Llama 3 менее склонна к типичным рефлексам безопасности (safety refusals) крупных коммерческих моделей и лучше генерирует контринтуитивные сценарии. Открытая модель -- максимальное разнообразие по отношению к закрытым моделям Anthropic/OpenAI/Google. Низкая стоимость позволяет давать ей больше токенов на развёрнутую аргументацию.
