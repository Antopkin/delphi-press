---
title: "Полиамаркет: задача информированного консенсуса"
description: "Построение взвешенного консенсуса исторически точных участников prediction markets для получения сигнала, превосходящего рыночную цену."
---
