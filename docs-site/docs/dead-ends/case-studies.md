---
title: "Кейс-исследования: тупики и уроки"
description: "В этом разделе документированы 21 кейс-исследование из 6 месяцев разработки Delphi Press, организованные по категориям: 4 проблемы API, 4 архитектурные ошибки, 8 критических багов и 5 отложенных..."
---
