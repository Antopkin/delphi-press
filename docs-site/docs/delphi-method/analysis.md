---
title: "Стадия 3: Анализ траектории и оценки"
description: "На стадии 3 (анализ траектории) событийные нити, идентифицированные EventTrendAnalyzer, поступают в три специализированных аналитических агента, работающих параллельно:"
---
