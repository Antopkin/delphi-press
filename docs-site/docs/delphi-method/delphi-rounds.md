---
title: "Раунды Дельфи: R1 и R2"
description: "В пайплайне Delphi Press используется двухраундовый метод Дельфи (Dalkey & Helmer 1963) с пятью синтетическими экспертными персонами и алгоритмической медиацией между раундами. Каждый раунд..."
---
